...
namespace OpenSource.UPnP
{
    ...
    public sealed class AsyncSocket
    {
        ...
        {
            add { OnConnectEvent.Register(value); }
            remove { OnConnectEvent.UnRegister(value); }
        }
        ...
        {
            add { OnConnectFailedEvent.Register(value); }
            remove { OnConnectFailedEvent.UnRegister(value); }
        }
        ...
        {
            add { OnDisconnectEvent.Register(value); }
            remove { OnDisconnectEvent.UnRegister(value); }
        }
        ...
        public void AddMembership(IPEndPoint local, IPAddress MulticastAddress)
        {
            ...
            {
                EventLogger.Log(ex);
                EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Cannot AddMembership to IPAddress: " + MulticastAddress.ToString());
            }
            try
            {
            ...
            {
                EventLogger.Log(ex);
                EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Cannot Set Multicast Interface to IPAddress: " + local.Address.ToString());
            }
        }
            ...
            lock (SendLock)
            {
                lock (CountLock)
                {
                    ...
                    else
                    {
                        ...
                        {
                            EventLogger.Log(ex);
                            EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Send Failure [Normal for non-pipelined connection]");
                            Disconnect = true;
                        }
                    }
                }
