...
namespace OpenSource.UPnP
{
    ...
    public sealed class HTTPSession
    {
        ...
        {
            get { return (ChunkedHeadersAdded); }
        }
        ...
        {
            add { OnSniffPacketEvent.Register(value); }
            remove { OnSniffPacketEvent.UnRegister(value); }
        }
        ...
        {
            add { OnRequestAnsweredEvent.Register(value); }
            remove { OnRequestAnsweredEvent.UnRegister(value); }
        }
        ...
        {
            add { OnStreamDoneEvent.Register(value); }
            remove { OnStreamDoneEvent.UnRegister(value); }
        }
        ...
        {
            add { OnCreateSessionEvent.Register(value); }
            remove { OnCreateSessionEvent.UnRegister(value); }
        }
        ...
        {
            add { OnCreateFailedEvent.Register(value); }
            remove { OnCreateFailedEvent.UnRegister(value); }
        }
        ...
        {
            add { OnClosedEvent.Register(value); }
            remove { OnClosedEvent.UnRegister(value); }
        }
        ...
        {
            add { OnSendReadyEvent.Register(value); }
            remove { OnSendReadyEvent.UnRegister(value); }
        }
        ...
        {
            add { OnSniffEvent.Register(value); }
            remove { OnSniffEvent.UnRegister(value); }
        }
        ...
        private void HandleDisconnect(AsyncSocket sender)
        {
            ...
            if (this.NeedToWaitToClose == true)
            {
                if (UserStream == null)
                {
                    ...
                    {
                        EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Information, Headers.StringPacket);
                    }
                    ...
                    (buffer[BufferSize - 2] == 13) && (buffer[BufferSize - 1] == 10))
                {
                    ...
                    if (Headers.StatusCode != -1)
                    {
                        if (Headers.StatusCode >= 100 && Headers.StatusCode <= 199)
                        {
                            ...
                            if (EventLogger.Enabled)
                            {
                                EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Information, "<<IGNORING>>\r\n" + Headers.StringPacket);
                            }
        ...
        {
            get { return ((IPEndPoint) MainSocket.RemoteEndPoint); }
        }
        ...
        public void Send(HTTPMessage Packet)
        {
            ...
            if (EventLogger.Enabled)
            {
                EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Information, Packet.StringPacket);
            }
