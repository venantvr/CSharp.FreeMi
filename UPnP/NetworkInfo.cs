...
namespace OpenSource.UPnP
{
    ...
    public sealed class NetworkInfo
    {
        ...
        {
            add { OnNewInterfaceEvent.Register(value); }
            remove { OnNewInterfaceEvent.UnRegister(value); }
        }
        ...
        {
            add { OnInterfaceDisabledEvent.Register(value); }
            remove { OnInterfaceDisabledEvent.UnRegister(value); }
        }
