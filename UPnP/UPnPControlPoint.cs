...
namespace OpenSource.UPnP
{
    ...
    public sealed class UPnPControlPoint
    {
        ...
        {
            if (IsAlive && LocationURL != null) EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, LocationURL.ToString());
        ...
        public void FindDeviceAsync(String SearchTarget, IPEndPoint RemoteEP)
        {
            ...
            foreach (IPAddress localaddr in LocalAddresses)
            {
                ...
                {
                    EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "CP Failure: " + localaddr.ToString());
                    EventLogger.Log(ex);
                }
            }
        }
        ...
        private void OnReceiveSink2(byte[] buffer, IPEndPoint remote, IPEndPoint local)
        {
            ...
            EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, msg.RemoteEndPoint.ToString());
