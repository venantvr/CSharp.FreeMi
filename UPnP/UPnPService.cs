...
namespace OpenSource.UPnP
{
    ...
    public class UPnPStateVariable : ICloneable
    {
        ...
        public void SetRange(Object Min, Object Max, Object Step)
        {
            ...
            if (Min != null)
            {
                ...
                {
                    EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Type Checking Failed (minimum value): " + ConvertFromUPnPType(VarType).FullName +
            ...
            if (Max != null)
            {
                ...
                {
                    EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Type Checking Failed (maximum value): " + ConvertFromUPnPType(VarType).FullName +
            ...
            if (Step != null)
            {
                ...
                {
                    EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Type Checking Failed (step value): " + ConvertFromUPnPType(VarType).FullName +
        ...
        internal void Validate(Object NewVal)
        {
            ...
            {
                EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Type Checking Failed: " + ConvertFromUPnPType(VarType).FullName +
            ...
            else
            {
                ...
                if (this.AllowedStringValues != null)
                {
                    ...
                    if (OK == false)
                    {
                        EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Type Checking Failed: " + NewVal.ToString() + " NOT in allowed value list");
                ...
                else
                {
                    ...
                    if (MinVal != null)
                    {
                        ...
                        {
                            EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Type Checking Failed: " + "Specified value: " + NewVal.ToString() + " must be >= " + MinVal.ToString());
                    ...
                    if (MaxVal != null)
                    {
                        ...
                        {
                            EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error, "Type Checking Failed: " + "Specified value: " + NewVal.ToString() + " must be <= " + MaxVal.ToString());
    ...
    public sealed class UPnPService : ICloneable
    {
        ...
        {
            add { PeriodicRenewFailedEvent.Register(value); }
            remove { PeriodicRenewFailedEvent.UnRegister(value); }
        }
        ...
        {
            add { SubscriptionAddedEvent.Register(value); }
            remove { SubscriptionAddedEvent.UnRegister(value); }
        }

        public event OnSubscriptionHandler OnSubscriptionRemoved
        {
            add { SubscriptionRemovedEvent.Register(value); }
            remove { SubscriptionRemovedEvent.UnRegister(value); }
        }
        ...
        internal static UPnPService Parse(String XML, int startLine)
        {
                ...
                if ((OnInvokeError != null) || (state.ErrorCB != null))
                {
                    if ((response.StatusCode == 500) && (response.BodyBuffer.Length > 0))
                    {
                        ...
                        try
                        {
                            ...
                            EventLogger.Log(this, System.Diagnostics.EventLogEntryType.Error,
                    ...
                    while ((XMLDoc.LocalName != "propertyset") && (XMLDoc.EOF == false))
                    {
                        ...
                        if (StateVariables.ContainsKey(name) == true)
                        {
                            ...
                            try
                            {
                                ...
                                var.Value = RetVal;
                                EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, RetVal.ToString());
